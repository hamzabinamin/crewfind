...
with_node \
  ...
  --target "/Users/hamzabinamin/Desktop/React Native/crewfind/ios/Pods/Target Support Files/Pods-crewfind/ExpoModulesProvider.swift" \
  --entitlement "/Users/hamzabinamin/Desktop/React Native/crewfind/ios/crewfind/crewfind.entitlements" \
  --platform "apple" \
  --packages "expo" "expo-application" "expo-asset" "expo-constants" "expo-dev-launcher" "expo-dev-menu" "expo-device" "expo-eas-client" "expo-file-system" "expo-font" "expo-image-picker" "expo-keep-awake" "expo-linear-gradient" "expo-linking" "expo-location" "expo-router" "expo-splash-screen" "expo-system-ui" "expo-updates" "expo-web-browser"
