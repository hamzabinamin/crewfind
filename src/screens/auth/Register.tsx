      ...
      <Container>
          ...
          <Form>
              <InputContainer>
                  ...
                  <Input placeholder="Name" placeholderTextColor="#999999" keyboardType="default" />
              </InputContainer>
              <InputContainer>
                  <StyledIconEmail name="user" size={20} color="#999" />
                  <Input placeholder="Surname" placeholderTextColor="#999999" keyboardType="default" />
              </InputContainer>
              <InputContainer>
              ...
              <InputContainer>
                  ...
                  <Input placeholder="Base" placeholderTextColor="#999999" keyboardType="default" />
              </InputContainer>
              <InputContainer>
                  <StyledIconEmail name="flag" size={20} color="#999999" />
                  <Input placeholder="Nationality" placeholderTextColor="#999999" keyboardType="default" />
              </InputContainer>
